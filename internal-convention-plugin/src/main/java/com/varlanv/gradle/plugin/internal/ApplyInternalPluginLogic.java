...
import com.varlanv.gradle.plugin.InternalConventionExtension;
...
public class ApplyInternalPluginLogic {
    ...
    InternalConventionExtension internalConventionExtension;
                    ...
                    var createdMavenPublication = publishingExtension.getPublications().create(
                        ...
                        mavenPublication -> {
                            ...
                            mavenPublication.pom(pom -> {
                                pom.getUrl().set("https://github.com/varlanv/gradle-test-sync-plugin");
